...
TOOLCHAIN_NAME   := armv4t-4.2.1
TOOLCHAIN_PREFIX := $(HOST_PREBUILT)/$(TOOLCHAIN_NAME)/bin/armv4t-


TARGET_CFLAGS.common := \
	-I$(SYSROOT)/usr/include/ \
	-I$(SYSROOT)/usr/include/bionic/libc/arch-arm/include \
	-I$(SYSROOT)/usr/include/kernel/include \
	-I$(SYSROOT)/usr/include/bionic/libm/include \
	-I$(SYSROOT)/usr/include/bionic/libm/include/arm \
	-I$(SYSROOT)/usr/include/bionic/libc/include \
	-I$(SYSROOT)/usr/include/bionic/libstdc++/include \
	-I$(SYSROOT)/usr/include/nativehelper \
