        ...
        pj_bool_t close_slave)
{
    ...
    /* Do something.. */
    PJ_LOG(4, (THIS_FILE, "zrtp create transport"));
    ...
    *p_tp = &zrtp->base;
    ...
    PJ_LOG(4, (THIS_FILE, "zrtp transport creation done"));
    return PJ_SUCCESS;
}
...
PJ_DECL(void) pjmedia_transport_zrtp_setEnableZrtp(pjmedia_transport *tp, pj_bool_t onOff)
{
    ...
    PJ_LOG(4, (THIS_FILE, "zrtp enable..."));
                                                    ...
                                                    pj_ssize_t))
{
    ...
    PJ_LOG(4, (THIS_FILE, "Attach zrtp"));
                                      ...
                                      pj_size_t size)
{
    ...
    if (!zrtp->started && zrtp->enableZrtp) {
        if (zrtp->localSSRC == 0)
            zrtp->localSSRC = pui[2];   /* Get own SSRC before starting ZRTP */
