...
LOCAL_SRC_FILES+= cryptlib.c mem.c mem_clr.c mem_dbg.c cversion.c \
	...
	ec/ec_key.c  ec/ec_lib.c ec/ecp_smpl.c ec/ecp_mont.c ec/ecp_nist.c ec/ec_cvt.c ec/ec_mult.c \
	ec/ec_err.c ec/ec_curve.c ec/ec_check.c ec/ec_print.c ec/ec_asn1.c \
	ec/ec2_smpl.c ec/ec2_mult.c \
	ecdh/ech_lib.c ecdh/ech_ossl.c ecdh/ech_key.c ecdh/ech_err.c \
	engine/tb_ecdh.c 
